...
//
// Source: pkg/api/types/sdktypes/v1/ext/codex, codex-rs/core/src/tools.

import (
	"encoding/json"

	pb "github.com/ngicks/crabswarm/pkg/api/gen/proto/go/sdktypes/v1"
	codexpb "github.com/ngicks/crabswarm/pkg/api/gen/proto/go/sdktypes/v1/ext/codex"
	"github.com/ngicks/crabswarm/pkg/api/types/sdktypes/v1/ext/codex"
)

// CodexApplyPatchInput is the Codex apply_patch tool_input variant of
// [ToolInputSchemas] (tool_name "apply_patch").
//
// Source: pkg/api/types/sdktypes/v1/ext/codex (ApplyPatchInput)
...
//
// Source: pkg/api/types/sdktypes/v1/ext/codex (UpdatePlanInput)
...
// output.
//
// Source: pkg/api/types/sdktypes/v1/ext/codex (ApplyPatchOutput)
...
//
// Source: pkg/api/types/sdktypes/v1/ext/codex (ShellOutput)
