...
// state, so the numbers answer "how many if I click". Each count is one more
// evaluation of the source's listing, which is already in hand.
...
export function StateButtons({
  ...
  const count = (query: string) => filterIssues(listing, query).length;
